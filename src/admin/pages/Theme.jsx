...
import { FiSave, FiDroplet, FiSun, FiMoon, FiRefreshCw } from 'react-icons/fi';
        ...
        <div className="card-body">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(150px, 1fr))', gap: '15px' }}>
            ...
            >
              ...
              <p style={{ color: '#fff', fontSize: '12px', fontWeight: 500, textAlign: 'center' }}>{preset.name}</p>
            </button>
          ))}
          </div>
        </div>
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <div style={{ color: theme.textColor }}>
            ...
            <p style={{ opacity: 0.7 }}>This is how your text will appear with the current theme settings.</p>
          </div>
          <div style={{ display: 'flex', gap: '10px' }}>
